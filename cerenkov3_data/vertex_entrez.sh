...
if [ -f "${DIRECTORY}/${G2E_FILENAME}" ]; then
    echo "[Entrez] file '${DIRECTORY}/${G2E_FILENAME}' exists; skip downloading"
else
...
if [ -f "${DIRECTORY}/${BIOMART_G37_FILENAME}" ]; then
    echo "[Entrez] file '${DIRECTORY}/${BIOMART_G37_FILENAME}' exists; skip downloading"
else
...
if [ -f "${DIRECTORY}/${BIOMART_G38_FILENAME}" ]; then
    echo "[Entrez] file '${DIRECTORY}/${BIOMART_G38_FILENAME}' exists; skip downloading"
else
...
if [ -f "${DIRECTORY}/${GENCODE_G37_FILENAME}" ]; then
    echo "[Entrez] file '${DIRECTORY}/${GENCODE_G37_FILENAME}' exists; skip downloading"
else
...
if [ -f "${DIRECTORY}/${GENCODE_G38_FILENAME}" ]; then
    echo "[Entrez] file '${DIRECTORY}/${GENCODE_G38_FILENAME}' exists; skip downloading"
else
...
if [ -f "${DIRECTORY}/${HGNC_FILENAME}" ]; then
    echo "[Entrez] file '${DIRECTORY}/${HGNC_FILENAME}' exists; skip downloading"
else
